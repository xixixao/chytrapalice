...
/*
Ještě jedna věc, nechce se mi kvůli tomu zakládat novej topic.
Soubor DataGridAction.php
<?php
$control = $dataGrid->lookup('Nette\Application\Control', TRUE);

Když použiju DataGrid ve vlastní komponentě, $control se nastaví na mojí komponentu, která ale neumí generovat linky.
funkční řešení: (ale nevím jestli správné)
<?php
$control = $dataGrid->lookup('Nette\Application\Presenter', TRUE);
...
*/
	...
	public function generateLink(array $args = NULL)
	{
		...
		$control = $dataGrid->lookup('Nette\Application\Control', TRUE);
		//$control = $control->lookup('Nette\Application\Control', TRUE);
    //var_dump($control);
